...
const Sidebar: React.FC<SidebarProps> = ({ handleMenuToggle, isOpen }) => {
    return (
        <div className={`w-full h-screen bg-[#f5ebe0] fixed z-20 top-0 transition-transform duration-300 ease-in text-center bg-contain bg-bottom bg-no-repeat ${isOpen ? '' : 'transform translate-x-full'}`}
